    ...
    <main class="about">
        ...
        <section class="mission">
            ...
            <p>
                ...
                <ul>
                    <li>Empower creators by providing a space to showcase their talents.</li>
                    <li>Encourage learning and collaboration through workshops and events.</li>
                    <li>Support small businesses by enabling the sale of handmade goods.</li>
                </ul>
            </p>
        </section>
    </main>
